...
// export const BASE_URL_EPMS_EMP = "http://43.205.24.208:9009/performance/api/v1/employees";
...
export const BASE_URL_EMPLOYEE_EMAILS = "http://localhost:9020/api/v1/employees/emails";
