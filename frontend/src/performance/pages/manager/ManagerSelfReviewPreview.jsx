...
const ManagerSelfReviewPreview = () => {
  const navigate = useNavigate();
  const { empId } = useParams(); // Get empId from URL path - THIS IS THE EMPLOYEE'S ID
  ...
  useEffect(() => {
    console.log("=== MANAGER SELF REVIEW PREVIEW DEBUG ===");
    console.log("URL Params - empId (Employee ID):", empId);
  ...
  useEffect(() => {
    const fetchGoals = async () => {
      ...
      if (!employeeId) {
        setError("Employee ID not found in URL. Please check the URL format.");
        setLoading(false);
        return;
      }
      ...
      try {
        ...
        console.log("========================================");
        console.log("MANAGER VIEW - FETCHING EMPLOYEE GOALS FROM:", url);
  ...
  if (loading) {
    return (
      <div className="flex flex-col min-h-screen font-content bg-gray-50">
        <Header />
        <div className="mt-24">
          <LoadingAnimation message="Loading employee self review preview..." />
        </div>
      </div>
    );
  }
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <ul className="text-xs text-gray-600 space-y-1">
                <li>Employee ID from URL: <span className="font-mono font-bold text-red-600">{debugInfo.empIdFromUrl || 'undefined'}</span></li>
            ...
            <div className="space-y-3">
              ...
              <ul className="text-sm text-gray-600 list-disc list-inside ml-2">
                <li><span className="font-mono bg-gray-100 px-2 py-1 rounded">/manager/self-review/preview/9085499?year=2025&quarter=Q1</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mt-24 px-6 max-w-7xl mx-auto w-full pb-10">
        ...
        <div className="mb-8">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <h2 className="text-lg font-semibold text-blue-800 mb-2">Manager View</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-medium text-gray-900">Self Assessment Status</h2>
              <p className="text-sm text-gray-500 mt-1">
              ...
              {previewData.overallSelfReviewComments && (
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-gray-700 whitespace-pre-wrap">{previewData.overallSelfReviewComments}</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h2 className="text-lg font-medium text-gray-900">Predefined Goals with Self Review</h2>
            {goals.length === 0 && (
...
export default ManagerSelfReviewPreview;