...
const ManagerApproval = ({ rowData, onClose }) => {
  ...
  useEffect(() => {
    if (rowData) {
      ...
      let columns = [];
      if (rowData.claimType === "ConveyanceClaim") {
        columns = [
          {
          ...
          {
            name: (
              <span className="text-base font-semibold">From Location</span>
            ),
            selector: (row) => <ReadOnlyInputCell value={row.fromLocation} />,
          },
          {
            name: <span className="text-base font-semibold">To Location</span>,
            selector: (row) => <ReadOnlyInputCell value={row.toLocation} />,
          },
          {
            name: <span className="text-base font-semibold">From Time</span>,
            selector: (row) => <ReadOnlyInputCell value={row.fromTime} />,
          },
          {
            name: <span className="text-base font-semibold">To Time</span>,
            selector: (row) => <ReadOnlyInputCell value={row.toTime} />,
          },
          {
          ...
          {
            name: <span className="text-base font-semibold">Mode</span>,
            selector: (row) => <ReadOnlyInputCell value={row.modeOfTravel} />,
          },
          {
            name: <span className="text-base font-semibold">KM</span>,
            selector: (row) => <ReadOnlyInputCell value={row.distance} />,
          },
          {
      ...
      } else if (rowData.claimType === "TravelClaim") {
        columns = [
          { name: "S.No", selector: (row) => 1 },
          {
            name: "Exp Type",
            selector: (row) => <ReadOnlyInputCell value={row.expMode} />,
          },
          {
            name: "From Location",
            selector: (row) => <ReadOnlyInputCell value={row.fromLocation} />,
      ...
      } else if (rowData.claimType === "FoodClaim") {
        columns = [
          { name: "S.No", selector: (row) => 1 },
          {
            name: "Date",
      ...
      } else if (rowData.claimType === "MobileClaim") {
        columns = [
          { name: "S.No", selector: (row) => 1 },
          {
            name: "Date",
      ...
      } else if (rowData.claimType === "MiscellaneousClaim") {
        columns = [
          { name: "S.No", selector: (row) => 1 },
          {
            name: "Date",
            ...
            <div className="border border-gray-300 shadow-md p-2">
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-5">
                  ...
                  <div className="flex md:space-x-36 space-x-[70px] p-3 mt-3 md:text-base text-xs">
                    <div className="font-medium text-gray-700">WBS</div>
                    <div className="ml-5">{rowData?.wbsId}</div>
                  </div>
                  <div className="p-3">
                    <h4 className="md:my-2 my-4 md:text-xs text-xs">
                      Choose Expense Type to Continue
                    </h4>
                    <div className="flex md:space-x-20 space-x-2 md:text-base text-xs">
