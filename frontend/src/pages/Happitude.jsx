...
useEffect(() => {
  window.scrollTo(0, 0);
    ...
    const people = [
        { src: "../assets/happ3", name: "John Doe", role: "Wellness Coach" },
        { src: "../assets/h5.jpg", name: "John Doe", role: "Wellness Coach" },
        { src: "person4.jpg", name: "John Doe", role: "Wellness Coach" },
        { src: "person6.jpg", name: "John Doe", role: "Wellness Coach" },
    ];

    return (
        <><Header /><div className='pt-28 px-4 sm:px-10 lg:px-[140px] mb-10'>
