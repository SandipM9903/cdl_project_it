...
function ProfileInfonfoFile() {
  ...
  // sessionStorage.setItem("empCode", "9085492");
  // const empCode = sessionStorage.getItem("empCode");
  console.log(empCode);
  // alert(empCode,"empCode");
  console.warn(empCode, "empCode");
  //  const empCode = sessionStorage.getItem("empCode");
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}:9020/employee/eCode/${empCode}`)
      .then((res) => {
        console.log(res?.data, "6666");
        const { fileAndObjectTypeBean } = res?.data;
        // const {empResDTO}=fileAndObjectTypeBean;
        // console.warn(empResDTO,"empResDTO 5555");
        // setProfileInfo(fileAndObjectTypeBean);
        setProfileInfo(res?.data);
        console.log(fileAndObjectTypeBean, { depth: null });
        console.log(profileInfo?.file, "file 333");
      });
    // }
    // );
  }, [empCode]);
      ...
      <div className="">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg h-full w-full">
          <div className="bg-white-300">
            <div className="grid grid-cols-1 bg-white md:grid-cols-2 lg:grid-cols-10 pt-6 mt-6 shadow-lg border border-white py-6 pl-3 rounded-md">
                  ...
                  <div className="img">
                    <div className="relative inline-block">
                      ...
                      <img
                        ...
                        src={profileInfo?.file || fallbackImageUrl} // Use fallback image if no image is available
                        alt="Profile"
                ...
                <div className="div pt-8">
                  <div className="div1  flex space-x-5 pl-10 p-7">
                    <div className="emp w-56 flex-col ">
                      <h3 className="font-normal text-normal">Employee Code</h3>
                    ...
                    <div className="">
                      ...
                      <h2 className="text-blue-900 font-semibold ml-4 ">
                        {
                          profileInfo?.fileAndObjectTypeBean?.empResDTO
                            ?.primaryContactNo
                        }{" "}
                  ...
                  <div className="div2  flex space-x-52 pl-10 p-7 pb-10">
                    <div className="dept flex w-56 flex-col">
                      ...
                      <h2 className="text-green-500 font-semibold ">
                        {profileInfo?.fileAndObjectTypeBean?.empResDTO?.status}
                      </h2>
                    </div>
                  </div>
                </div>
            ...
            {/* empcode behave as empCode */}
            <Components empCode={empCode} />
          </div>
        </div>
      </div>
    </>
