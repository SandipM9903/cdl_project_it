...
function ConfirmationDueReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Confirmation Due Report"
            sheetName="Confirmation Due Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Confirmation Due Report"
            data={employees}
...
export default ConfirmationDueReport;