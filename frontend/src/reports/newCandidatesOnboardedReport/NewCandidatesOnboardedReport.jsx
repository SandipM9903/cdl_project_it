...
function NewCandidatesOnboardedReport() {
    ...
    return (
        <ReportLayout
            reportTitle="New Candidates Onboarded Report"
            sheetName="New Candidates Onboarded Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the New Candidates Onboarded Report"
            data={employees}
...
export default NewCandidatesOnboardedReport;