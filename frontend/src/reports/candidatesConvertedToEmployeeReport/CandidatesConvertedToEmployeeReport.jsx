...
function CandidatesConvertedToEmployeeReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Candidates Converted to Employee Report"
            sheetName="Candidates Converted to Employee Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Candidates Converted to Employee Report"
            data={employees}
...
export default CandidatesConvertedToEmployeeReport;