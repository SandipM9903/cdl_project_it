...
function CDLUserLogReport() {
    ...
    return (
        <ReportLayout
            reportTitle="CDL User Log Report"
            sheetName="CDL User Log Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the CDL User Log Report"
            data={employees}
...
export default CDLUserLogReport;