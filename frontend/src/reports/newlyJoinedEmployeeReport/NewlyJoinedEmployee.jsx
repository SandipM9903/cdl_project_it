...
function NewlyJoinedEmployeeReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Newly Joined Employee Report"
            sheetName="Newly Joined Employee Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Newly Joined Employee Report"
            data={employees}
...
export default NewlyJoinedEmployeeReport;