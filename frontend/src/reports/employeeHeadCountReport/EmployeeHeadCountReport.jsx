...
function EmployeeHeadCountReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Employee Head Count Report"
            sheetName="Employee Head Count Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Employee Head Count Report"
            data={employees}
...
export default EmployeeHeadCountReport;