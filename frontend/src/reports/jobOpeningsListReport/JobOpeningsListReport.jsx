...
function JobOpeningsListReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Job Openings List Report"
            sheetName="Job Openings List Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Job Openings List Report"
            data={employees}
...
export default JobOpeningsListReport;