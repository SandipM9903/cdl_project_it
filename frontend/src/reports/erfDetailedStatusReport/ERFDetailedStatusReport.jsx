...
function ERFDetailedStatusReport() {
    ...
    return (
        <ReportLayout
            reportTitle="ERF Detailed Status Report"
            sheetName="ERF Detailed Status Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the ERF Detailed Status Report"
            data={employees}
...
export default ERFDetailedStatusReport;