...
function LocationWiseEmployeeCountReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Location Wise Employee Count Report"
            sheetName="Location Wise Employee Count Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Location Wise Employee Count Report"
            data={employees}
...
export default LocationWiseEmployeeCountReport;