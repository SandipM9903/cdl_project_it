...
function JobDetailStatusReport() {
  ...
  return (
    <ReportLayout
      reportTitle="Job Detail Status Report"
      sheetName="Job Detail Status Report"
      columnOptions={columnOptions}
      availableOptionsLabel="Select The Columns to display in the Job Detail Status Report"
      data={employees}
...
export default JobDetailStatusReport;
