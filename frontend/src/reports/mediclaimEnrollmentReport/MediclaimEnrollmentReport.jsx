...
function MediclaimEnrollmentReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Mediclaim Enrollment Report"
            sheetName="Mediclaim Enrollment Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Mediclaim Enrollment Report"
            data={employees}
...
export default MediclaimEnrollmentReport;