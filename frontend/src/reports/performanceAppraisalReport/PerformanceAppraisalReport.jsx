...
function PerformanceAppraisalReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Performance Appraisal Report"
            sheetName="Performance Appraisal Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Performance Appraisal Report"
            data={employees}
