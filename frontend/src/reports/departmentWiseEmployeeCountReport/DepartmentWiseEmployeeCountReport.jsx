...
function DepartmentWiseEmployeeCountReport() {
    ...
    return (
        <ReportLayout
            reportTitle="Department Wise Employee Count Report"
            sheetName="Department Wise Employee Count Report"
            columnOptions={columnOptions}
            availableOptionsLabel="Select The Columns to display in the Department Wise Employee Count Report"
            data={employees}
...
export default DepartmentWiseEmployeeCountReport;